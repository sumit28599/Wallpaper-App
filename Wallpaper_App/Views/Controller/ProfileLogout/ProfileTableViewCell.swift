...
class ProfileTableViewCell: UITableViewCell {
    ...
    //MARK: Set all ui view
    func setAllUIView() {
        // Initialize and configure profile image container
        profileImageContainerView = UIView()
        profileImageContainerView.translatesAutoresizingMaskIntoConstraints = false
        profileImageContainerView.layer.cornerRadius = 16  // Half of the width & height to make it circular
        profileImageContainerView.layer.masksToBounds = true // Ensure content stays within the circular bounds
        profileImageContainerView.backgroundColor = .darkPink // Placeholder color
